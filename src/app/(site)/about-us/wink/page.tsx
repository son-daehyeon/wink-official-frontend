...
import WaveImage from './ui/wave-image';
import WeAreWink from './ui/we-are-wink';

import { WaveSection } from '@/shared/ui/wave-section';
...
export default function WinkPage() {
  return (
    <div className="flex flex-col items-center pt-44 sm:pt-52 space-y-10">
      ...
      <WaveSection className="flex-col sm:flex-row gap-4 sm:gap-8">
        <AnimatedDiv
