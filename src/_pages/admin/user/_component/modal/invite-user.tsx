...
import { InviteRequest, InviteRequestSchema } from '@/entities/user';
import { inviteAdminUser } from '@/features/admin';
...
export default function InviteUserModal({ open, setOpen }: InviteUserModalProps) {
  ...
  const onSubmit = useCallback(
    (values: InviteRequest) => {
      startApi(() => inviteAdminUser(values), {
