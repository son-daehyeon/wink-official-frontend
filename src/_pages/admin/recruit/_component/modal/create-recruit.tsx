...
import { CreateRecruitRequest, CreateRecruitRequestSchema } from '@/entities/recruit';
import { Recruit } from '@/entities/recruit';
import { createAdminRecruit } from '@/features/admin';
import { cn, formatDate, formatDateApi } from '@/shared/lib/cn';
...
export default function CreateRecruitModal({ open, setOpen, callback }: CreateRecruitModalProps) {
  ...
  const onSubmit = useCallback(
    (values: CreateRecruitRequest) => {
      startApi(async () => callback((await createAdminRecruit(values)).recruit), {
    ...
    [callback, form, setOpen, startApi],
  );
