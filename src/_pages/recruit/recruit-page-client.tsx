...
import DomainCard from './_component/domain-card';
import InfoCard, { Info } from './_component/info-card';
import Items from './_component/items';
import RecruitTitle from './_component/recruit-title';
import Rocket from './_component/rocket';
import ScrollDown from './_component/scroll-down';
import { domains } from './_constant/domain';
import { qnas } from './_constant/qna';
