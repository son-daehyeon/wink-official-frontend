...
import { frontendTechStacks } from '../_constant/tech_stack';
import { RecruitStepProps } from '../page';

import { FrontendTechStack } from '@/entities/recruit';
...
export default function Step13({ go, form }: RecruitStepProps) {
  ...
  const initialNavigation = useRef({ back, stack, step });

  const [clicked, setClicked] = useState(false);

  useEffect(() => {
    const { back, stack, step } = initialNavigation.current;
