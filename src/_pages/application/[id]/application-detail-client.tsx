...
import GeneralSetting from './_component/layout/GeneralSetting';
import LoginSetting from './_component/layout/LoginSetting';
import DeleteApplicationModal from './_component/modal/delete-application';
import UpdateApplicationModal from './_component/modal/update-application';
...
export default function ApplicationDetailClient({ id }: ApplicationDetailClientProps) {
  ...
  if (isPending || !application) return <Loading />;
