...
import CreateHistoryModal from './_component/modal/create-history';
import DeleteHistoryModal from './_component/modal/delete-history';
import UpdateHistoryModal from './_component/modal/update-history';
