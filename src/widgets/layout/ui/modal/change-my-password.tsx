import { UpdateMyPasswordRequest, UpdateMyPasswordRequestSchema } from '@/entities/user';
import { useUpdateMyPasswordMutation } from '@/features/user';
...
export default function ChangePasswordModal({ open, setOpen }: ChangeMyInfoModalProps) {
  ...
  const onSubmit = (values: UpdateMyPasswordRequest) =>
    startApi(() => updateMyPassword.mutateAsync(values), {
